...
public abstract class TrackerServer implements TrackerConnector {
    ...
    public TrackerServer(ApplicationContext context, String protocol, boolean datagram) {
        ...
        BasePipelineFactory pipelineFactory = new BasePipelineFactory(context, this, protocol) {
            @Override
