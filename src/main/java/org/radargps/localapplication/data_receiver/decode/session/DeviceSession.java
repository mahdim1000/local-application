...
public class DeviceSession {
    ...
    private final DeviceReadEntityType readEntityType;
    private final Protocol protocol;
    private final Channel channel;
    private final SocketAddress remoteAddress;

    public DeviceSession(UUID deviceId, String uniqueId, DeviceType type,
                         DeviceReadEntityType readEntityType, Protocol protocol,
